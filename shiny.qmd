...
<a href="shiny.html"> <button type="button" class="btn btn-primary active btn-sm">English</button></a> 

<a href="index-pt.html"> <button type="button" class="btn btn-primary btn-sm" disabled>Português</button></a>
:::
